    ...
    <div class="container">
        ...
        <nav id="nav-menu-container">
            <ul class="nav-menu">
                ...
                <li><a href="<?php echo site_url('home'); ?>">Services</a></li>
        ...
        <div class="card card-signin my-5">
          <div class="card-body text-left">
            ...
            <form class="form-signin" action="" method="POST">
               <div class="form-lael-group">  </div>
              <div class="form-label-group">
                <input type="email" name="email" id="inputemail" class="form-control" placeholder="Email Address"
                      required autofocus value="">
                    <div class="text-danger my-1 err"></div>  
              ...
              <button class="btn btn-lg btn-primary btn-block text-uppercase my-4" type="submit" name="submit">Sign in</button>
              <hr class="my-4">     
            </form>
