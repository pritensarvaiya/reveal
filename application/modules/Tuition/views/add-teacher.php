...
<body>
    ...
    <div class="w3-sidebar w3-bar-block w3-collapse w3-card w3-animate-left"
        ...
        <a href="<?php echo site_url('add-tuition-teacher'); ?>" class="w3-bar-item w3-button active-menu">Add
            Teacher</a>
            ...
            <main>
                ...
                <div class="container">
                    <div class="card">
                        ...
                        <form action="<?php echo site_url('add-tuition-teacher') ?>" method="POST">
                        ...
                        <div class="form-group"><label class="form-label">Class</label>
                            <select class="form-control" id="form_name" name="class[]" multiple size='<?php echo sizeof($class); ?>'>
