...
<body>
    ...
    <div class="w3-sidebar w3-bar-block w3-collapse w3-card w3-animate-left"
        ...
        <a href="<?php echo site_url('student-attendance'); ?>" class="w3-bar-item w3-button active-menu">Attendance</a>
            ...
            <main>
                ...
                <ol class="breadcrumb mb-4 mt-md-4">
                    <li class="breadcrumb-item active">
                        <h2 class="mt-4">Select Class And Date</h2>
                    </li>
                </ol>
                            ...
                            <div class="col-md-6">
                                <div class="form-group"><label class="form-label">Class</label>
                                    <select class="form-control" id="form_name" name="class">
                                        ...
                                        <option value="<?= $value['class_name'].','.$value['medium'] ?>" <?php if(isset($class_name) && $class_name == $value['class_name'] && $medium == $value['medium']){ echo 'selected'; } ?>>
