...
<body>
    ...
    <div class="w3-sidebar w3-bar-block w3-collapse w3-card w3-animate-left"
        ...
        <a href="<?php echo site_url('tuition-teacher-list'); ?>" class="w3-bar-item w3-button active-menu">Teachers List</a>
                    ...
                    <div class="card">
                        <div class="card-header">
                            <ul class="nav nav-pills card-header-pills">
                                <li class="nav-item">
                                    <a class="btn btn-outline-danger" href="<?php echo site_url('add-tuition-teacher'); ?>">Add Teacher</a>
                                </li>
                            </ul>
                        </div>
                        <div class="card-body">
                        ...
                        <tbody>  
                            ...
                            <?php  foreach ($class_data as $key => $value) { ?>
                                <tr>
                                    ...
                                    <td><a href="<?php echo site_url('Tuition/getTeacher/'.$value['teacher_id']); ?> "><button class="btn btn-outline-primary">Update</button></a></td>
                                    <td><a href="<?php echo site_url('Tuition/deleteTeacher/'.$value['teacher_id']); ?> "><button class="btn btn-outline-danger">Delete</button></a></td>
                                </tr>
                                <?php $i++; ?>
                            <?php }  ?>
                        </tbody>
