            ...
            <main>
                ...
                <div class="card">
                        <div class="card-body my-4">
                            <form action="<?php echo site_url('Tuition/updateClass/'.$id) ?>" method="POST">
                                <div class="form-group">
                                    <label for="fees">Fees </label>
                                    <input type="text" class="form-control" name="fees" id="fees" value="<?php echo $class_fees; ?>">
