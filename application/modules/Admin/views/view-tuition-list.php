...
<body>
    ...
    <div class="w3-sidebar w3-bar-block w3-collapse w3-card w3-animate-left"
        ...
        <a href="<?php echo site_url('admin/view-tuition-list'); ?>" class="w3-bar-item w3-button active-menu">Tuition List</a>
                        ...
                        <tbody>
                            ...
                            <?php  foreach ($data as $value) { ?>
                                <tr>
                                    ...
                                    <td><?php echo $value['tuition_mobile']; ?></td>
                                    <td><?php echo $value['tuition_email']; ?></td>
                                    <td><?php echo $value['tuition_address']; ?></td>
                                    <td><?php echo $value['tuition_city']; ?></td>
                                </tr>
                                <?php $i++; ?>
                            <?php }  ?>
                        </tbody>
