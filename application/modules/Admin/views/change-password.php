...
<body>
    ...
    <div class="w3-sidebar w3-bar-block w3-collapse w3-card w3-animate-left"
        ...
        <a href="<?php echo site_url('admin/change-password'); ?>" class="w3-bar-item w3-button active-menu">Change Password</a>
    </div>
    ...
    <div class="w3-main" style="margin-left:200px">
        ...
        <div class="w3-container">
            ...
            <main>
                ...
                <?php } ?>
                <form action="<?php echo site_url('admin/change-password') ?>" method="POST">
