...
<body>
    ...
    <div class="w3-sidebar w3-bar-block w3-collapse w3-card w3-animate-left"
        ...
        <a href="<?php echo site_url('admin/admin-dashboard'); ?>" class="w3-bar-item w3-button active-menu">Dashboard</a>
                                ...
                                <table id="myTable" class="table table-bordered table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><a
                                                    href="<?php echo site_url('Admin/viewMessage/'.$value['id']); ?> "><button
